...
use crate::steam_client::steamworks_types::{
    ...
    ECommunityProfileItemProperty, ECommunityProfileItemType, EFriendRelationship,
    EOverlayToStoreFlag, EPersonaState, FriendGameInfo_t, FriendsGroupID_t, SteamAPICall_t,
};
...
pub struct ISteamFriendsVTable {
    ...
    pub get_friend_persona_state:
        unsafe extern "C" fn(*mut ISteamFriends, CSteamID) -> EPersonaState,
    pub get_friend_persona_name:
        unsafe extern "C" fn(*mut ISteamFriends, CSteamID) -> *const c_char,
    ...
    pub get_clan_activity_counts: unsafe extern "C" fn(
        *mut ISteamFriends,
        CSteamID,
        *mut c_int,
        *mut c_int,
    ...
    pub get_friend_rich_presence_key_count:
        unsafe extern "C" fn(*mut ISteamFriends, CSteamID) -> c_int,
    ...
    pub is_clan_chat_window_open_in_steam:
        unsafe extern "C" fn(*mut ISteamFriends, CSteamID) -> bool,
    ...
    pub get_num_chats_with_unread_priority_messages:
        unsafe extern "C" fn(*mut ISteamFriends) -> c_int,
